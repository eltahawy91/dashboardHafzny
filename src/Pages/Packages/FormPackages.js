...
//   const [selectedPlan, setSelectedPlan] = useState(null);
  ...
  function handleInputChange(e) {
    ...
    //   if (e.target.type === "checkbox" && e.target.id === 1) {
  ...
  const handleSubmit = (event) => {
    ...
    const apiFunction = data
      ? postData(`plans/${id}`, formData)
      : postData("plans", formData);
          ...
          <div className="firstSection">
            ...
            <div className="secondSection">
              <input
                type="number"
                id="sort_order"
                value={dataInput.sort_order}
                onChange={(e) => handleInputChange(e)}
                placeholder="ترتيب الباقه"
              />
              <input
                type="number"
                id="price"
                ...
                onChange={(e) => handleInputChange(e)}
                placeholder="سعر الباقه"
              />
              <input
                type="number"
                id="total_hours"
                value={dataInput.total_hours}
                onChange={(e) => handleInputChange(e)}
                placeholder="عدد الساعات المتاحه"
              />
              <input
                type="number"
                id="max_lectures"
                value={dataInput.max_lectures}
                onChange={(e) => handleInputChange(e)}
